...
public class Users extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        userSearch.setBackground(new java.awt.Color(51, 51, 51));
        userSearch.setForeground(new java.awt.Color(255, 255, 255));

        searchButton.setBackground(new java.awt.Color(153, 0, 255));
        ...
        editButton.setBackground(new java.awt.Color(153, 0, 255));
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                ...
                DAOUsers dao = new DAOUsersImpl();
                Dashboard.ShowJPanel(new UpUsers((Models.Users) dao.getUserById(userId)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
